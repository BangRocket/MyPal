...
describe('useMetrics', () => {
  ...
  it('queryFn fetches /metrics endpoint via fetch (not GraphQL)', async () => {
    ...
    const prometheusText = [
      '# HELP mypal_uptime_seconds Agent uptime in seconds.',
      '# TYPE mypal_uptime_seconds gauge',
      'mypal_uptime_seconds 42',
      '# HELP mypal_messages_received_total Total messages received.',
      '# TYPE mypal_messages_received_total counter',
      'mypal_messages_received_total 5',
      '# HELP mypal_messages_sent_total Total messages sent.',
      '# TYPE mypal_messages_sent_total counter',
      'mypal_messages_sent_total 3',
      '# HELP mypal_active_sessions Active sessions.',
      '# TYPE mypal_active_sessions gauge',
      'mypal_active_sessions 2',
      '# HELP mypal_memory_nodes Memory nodes.',
      '# TYPE mypal_memory_nodes gauge',
      'mypal_memory_nodes 10',
      '# HELP mypal_memory_edges Memory edges.',
      '# TYPE mypal_memory_edges gauge',
      'mypal_memory_edges 20',
      '# HELP mypal_mcp_tools MCP tools.',
      '# TYPE mypal_mcp_tools gauge',
      'mypal_mcp_tools 4',
      '# HELP mypal_tasks_pending Tasks pending.',
      '# TYPE mypal_tasks_pending gauge',
      'mypal_tasks_pending 1',
      '# HELP mypal_tasks_running Tasks running.',
      '# TYPE mypal_tasks_running gauge',
      'mypal_tasks_running 0',
      '# HELP mypal_tasks_done_total Tasks done.',
      '# TYPE mypal_tasks_done_total gauge',
      'mypal_tasks_done_total 7',
      '# HELP mypal_errors_total Errors.',
      '# TYPE mypal_errors_total counter',
      'mypal_errors_total 0',
    ].join('\n');
