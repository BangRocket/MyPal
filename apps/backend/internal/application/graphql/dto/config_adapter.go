...
func InputToViperKeyMap() map[string]string {
	return map[string]string{
		...
		"memoryVectorEnabled":          "memory.vector.enabled",
		"memoryVectorBackend":          "memory.vector.backend",
		"memoryVectorTopK":             "memory.vector.top_k",
		"memoryVectorQdrantEndpoint":   "memory.vector.qdrant.endpoint",
		"memoryVectorQdrantCollection": "memory.vector.qdrant.collection",
		"memoryVectorQdrantApiKey":     "memory.vector.qdrant.api_key",
		"memoryGraphEnabled":           "memory.graph.enabled",
		"memoryGraphBackend":           "memory.graph.backend",
		"memoryGraphFalkordbAddr":      "memory.graph.falkordb.addr",
		"memoryGraphFalkordbPassword":  "memory.graph.falkordb.password",
		"memoryGraphFalkordbGraph":     "memory.graph.falkordb.graph",
		"memoryGraphFilePath":          "memory.graph.file_path",
