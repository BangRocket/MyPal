...
function getDefaultFormValues(): Record<string, unknown> {
  return {
    ...
    memoryVectorBackend: "qdrant",
    memoryVectorTopK: 10,
    memoryVectorQdrantEndpoint: "http://localhost:6333",
    memoryVectorQdrantCollection: "mypal_memories",
    memoryVectorQdrantApiKey: "",
    memoryGraphEnabled: false,
    memoryGraphBackend: "falkordb",
    memoryGraphFalkordbAddr: "localhost:6379",
    memoryGraphFalkordbPassword: "",
    memoryGraphFalkordbGraph: "mypal_memory",
    memoryGraphFilePath: "data/graph.json",
    ...
    try {
      ...
      if (config) {
        ...
        setFormValues({
          ...
          memoryVectorEnabled: config.memory?.vector?.enabled ?? false,
          memoryVectorBackend: config.memory?.vector?.backend || "qdrant",
          memoryVectorTopK: config.memory?.vector?.topK ?? 10,
          memoryVectorQdrantEndpoint: config.memory?.vector?.qdrantEndpoint || "http://localhost:6333",
          memoryVectorQdrantCollection: config.memory?.vector?.qdrantCollection || "mypal_memories",
          memoryVectorQdrantApiKey: config.memory?.vector?.qdrantApiKey || "",
          memoryGraphEnabled: config.memory?.graph?.enabled ?? false,
          memoryGraphBackend: config.memory?.graph?.backend || "falkordb",
          memoryGraphFalkordbAddr: config.memory?.graph?.falkordbAddr || "localhost:6379",
          memoryGraphFalkordbPassword: config.memory?.graph?.falkordbPassword || "",
          memoryGraphFalkordbGraph: config.memory?.graph?.falkordbGraph || "mypal_memory",
          memoryGraphFilePath: config.memory?.graph?.filePath || "data/graph.json",
          ...
          configEncryptionEnabled: config.configEncryptionEnabled ?? true,
        ...
        body: JSON.stringify({
          ...
          variables: {
            input: {
              ...
              memoryVectorEnabled: v.memoryVectorEnabled,
              memoryVectorBackend: v.memoryVectorBackend,
              memoryVectorTopK: v.memoryVectorTopK,
              memoryVectorQdrantEndpoint: v.memoryVectorQdrantEndpoint,
              memoryVectorQdrantCollection: v.memoryVectorQdrantCollection,
              memoryVectorQdrantApiKey: v.memoryVectorQdrantApiKey,
              memoryGraphEnabled: v.memoryGraphEnabled,
              memoryGraphBackend: v.memoryGraphBackend,
              memoryGraphFalkordbAddr: v.memoryGraphFalkordbAddr,
              memoryGraphFalkordbPassword: v.memoryGraphFalkordbPassword,
              memoryGraphFalkordbGraph: v.memoryGraphFalkordbGraph,
              memoryGraphFilePath: v.memoryGraphFilePath,
              ...
              configEncryptionEnabled: v.configEncryptionEnabled,
